...
type ExtendConfig = {
  ...
  material?: { fog?: boolean } & Record<string, unknown>;
...
const MergedPlanes = forwardRef<THREE.Mesh, PlanesProps>(
...
const PlaneNoise = forwardRef<THREE.Mesh, PlanesProps>((props, ref) => (
  <MergedPlanes
    ref={ref}
